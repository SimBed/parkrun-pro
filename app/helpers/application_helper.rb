module ApplicationHelper
  ...
  # referrer parameter: on the turboized venue_stats page, we want to retain a close button after sorting
  # venue parameter: on the turboized venue_stats page, we want to retain a close button after sorting
  # def sortable(column:, coltitle: nil, default_direction: "asc", sort_column:, sort_direction:, data_action: nil, referrer: nil, venue: nil, date: nil)
  def sortable(column:, coltitle: nil, default_direction: "asc", sort_column:, sort_direction:, data_action: nil, referrer: nil, filters: nil)
