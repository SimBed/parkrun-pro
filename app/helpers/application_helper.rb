module ApplicationHelper
  ...
  def sortable(column:, coltitle: nil, default_direction: "asc", sort_column:, sort_direction:, data_action: nil, link_from: nil)
    ...
    if data_action # handle by stimulus
      ...
      link_to coltitle, { sort_option: column, sort_direction: direction, link_from: }, { class: css_class }
    end
  end
